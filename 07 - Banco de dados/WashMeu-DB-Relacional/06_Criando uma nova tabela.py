...
conexao = sqlite3.connect(ROOT_PATH / "meu_washbanco.sqlite")    # trocando a exptencao do nosso db "meu_washbanco.db" para "meu_washbanco.sqlite" por Causa do plugim que nao reconhece o .db ok
...
# utilizando o "cursor.execute" para criar a tabela
# CREATE TABLE produtos (id INTEGER PRIMARY KEY AUTOINCREMENT, nome VARCHAR(100), preco DECIMAL);
# OBS: Use "cursor.execute(""). para criar a tabela ok
